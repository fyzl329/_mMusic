...
import app.mmusic.android.DatabaseDependency
...
import app.mmusic.android.service.PlayerMediaBrowserService
import app.mmusic.android.service.PrecacheService
import app.mmusic.android.ui.components.themed.SecondaryTextButton
import app.mmusic.android.ui.components.themed.SliderDialog
import app.mmusic.android.ui.components.themed.SliderDialogBody
import app.mmusic.android.ui.screens.Route
import app.mmusic.android.ui.screens.logsRoute
import app.mmusic.android.utils.findActivity
import app.mmusic.android.utils.intent
import app.mmusic.android.utils.isIgnoringBatteryOptimizations
import app.mmusic.android.utils.smoothScrollToBottom
...
fun OtherSettings() {
    ...
    SettingsCategoryScreen(
        ...
        SecondaryTextButton(
            text = stringResource(
                if (showAdvanced) R.string.hide_advanced_settings else R.string.show_advanced_settings
            ),
            onClick = { showAdvanced = !showAdvanced },
            modifier = Modifier
                .fillMaxWidth()
                .padding(
                    start = Dimensions.Items.horizontalPadding,
                    bottom = Dimensions.Items.verticalPadding,
        ...
        SettingsGroup(title = stringResource(R.string.about)) {
            SettingsDescription(text = stringResource(R.string.settings_credit))
            SettingsEntry(
                ...
                onClick = {
                    runCatching {
                        context.startActivity(
                            Intent(Intent.ACTION_VIEW, "https://github.com/fyzl329".toUri())
                        )
                    }
                }
            )
            SettingsEntry(
                ...
                onClick = {
                    runCatching {
                        context.startActivity(
                            Intent(Intent.ACTION_SENDTO, "mailto:fayazulh329@gmail.com".toUri())
                        )
                    }
                }
            )
