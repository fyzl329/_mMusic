...
import app.mmusic.android.utils.currentLocale
import app.mmusic.android.utils.findActivity
import app.mmusic.android.utils.startLanguagePicker
import app.mmusic.core.ui.BuiltInFontFamily
import app.mmusic.core.ui.ColorMode
import app.mmusic.core.ui.ColorSource
import app.mmusic.core.ui.Darkness
import app.mmusic.core.ui.LocalAppearance
import app.mmusic.core.ui.ThumbnailRoundness
import app.mmusic.core.ui.googleFontsAvailable
    ...
    SettingsCategoryScreen(title = stringResource(R.string.appearance)) {
        ...
        SettingsGroup(title = stringResource(R.string.text)) {
            ...
            if (googleFontsAvailable()) EnumValueSelectorSettingsEntry(
                ...
                onCheckedChange = {
                    fontFamily = if (it) BuiltInFontFamily.System else BuiltInFontFamily.Helvetica
                }
            )
