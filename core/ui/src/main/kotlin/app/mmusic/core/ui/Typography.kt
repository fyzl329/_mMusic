...
import app.mmusic.core.ui.ColorParceler
    ...
    companion object : Parceler<Typography> {
        ...
        override fun create(parcel: Parcel) =
            parcelableCreator<SavedTypography>().createFromParcel(parcel).let {
                typographyOf(
                    color = it.color,
                    fontFamily = BuiltInFontFamily.valueOf(it.fontFamily),
...
@Parcelize
enum class BuiltInFontFamily : Parcelable {
    Poppins,
    Helvetica,
    Roboto,
    Montserrat,
...
private fun BuiltInFontFamily.googleFont() = when (this) {
    BuiltInFontFamily.Roboto -> GoogleFont("Roboto")
    BuiltInFontFamily.Montserrat -> GoogleFont("Montserrat")
    BuiltInFontFamily.Nunito -> GoogleFont("Nunito")
    BuiltInFontFamily.Rubik -> GoogleFont("Rubik")
    else -> null
}
...
fun typographyOf(
    ...
    val textStyle = TextStyle(
        fontFamily = when {
            fontFamily == BuiltInFontFamily.Helvetica -> FontFamily(
                Typeface.create("Helvetica", Typeface.NORMAL)
            )
            fontFamily == BuiltInFontFamily.System -> FontFamily.Default
            fontFamily.googleFont() != null -> googleFontsFamilyFrom(fontFamily)
            fontFamily == BuiltInFontFamily.Poppins -> poppinsFontFamily
